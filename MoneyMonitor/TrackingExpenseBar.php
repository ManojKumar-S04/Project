...
session_start();
    ...
    $query="select * from $expenseTable where tdate between '$fromdate' and '$todate'";
    $rows=$conn->query($query);
    $color_rows=$conn->query("select * from categoryexpense");
?>
<html>
    <head>
        <title>TrackingExpenseBar</title>
        <style>
            *
            {
        ...
        <script type="text/javascript">
            ...
            var data = google.visualization.arrayToDataTable([
                ...
                ['<?php echo $row["category"];?>',<?php echo $row['amount']; ?>,'<?php foreach($color_rows as $row1){if($row['category']==$row1['category']){ echo $row1["color"];} }?>'],
            <?php  }?>
            ]);
    ...
    <body>
        ...
        <div class="time">
            ...
            <div class="expense"><button><a href="TrackingExpenseBar.php" target="HomeMain">EXPENSE</a></button></div>
            <div class="income"><button><a href="TrackingIncomeBar.php" target="HomeMain">INCOME</a></button></div>

            <div id="columnchart_values"></div>

        </div>
        <div class="pie"><button><a href="TrackingExpensePie.php" target="HomeMain">PIE</a></button></div>
        <div class="bar"><button><a href="TrackingExpenseBar.php" target="HomeMain">BAR</a></button></div>
    </body>
</html>
