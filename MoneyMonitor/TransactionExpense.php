                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="button-edit-delete">
                            ...
                            <div class="delete"><button class="delete" value="<?php echo $row['id']; ?>"  name=delete>Delete</button></div>
                            </form> 
                            <form action='TransactionExpenseEdit.php' method=post>
                                <div class="edit"><button type=submit value="<?php echo $row['id']; ?>" name=edit>Edit</button></div>
                            </form>                      
                        </td>
                    </tr>
                    <?php $count++;} ?>
...
if(isset($_POST['delete'])){
    $id=$_POST['delete'];
    $query="delete from $expenseTable where id='$id'";
    $conn->query($query);
}
?>
