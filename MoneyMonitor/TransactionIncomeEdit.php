...
session_start();
$query1="select * from categoryincome";
...
$query2="select * from $incomeTable where id='$id'";
...
if(isset($_POST['submit'])){
    ...
    $amount=$_POST['amount'];
    $note=$_POST['note'];
    $query="update $incomeTable set tdate='$tdate',category='$category',amount='$amount',note='$note' where id= $id";
    if( $conn->query($query)===TRUE){
        header("Location: TransactionIncome.php");
    }
...
<html>
    ...
    <body>
        ...
        <div class="outer">
            <div class="income"><button style="color:white;">INCOME</button></div>
            ...
            <div class="back"><button><a href="TransactionIncome.php" target="HomeMain">BACK</a></button></div>
